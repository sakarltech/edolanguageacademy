...
- [x] Remove public registration page from navigation
- [x] Update dashboard to show course catalog for unenrolled users
- [x] Add in-dashboard course selection and payment flow
- [x] Allow users to purchase multiple course levels
